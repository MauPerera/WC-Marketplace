<?php
/**
 * The template for displaying vendor shop settings
 *
...
if($vendor) {
	...
	<div class="wcmp_main_holder toside_fix">
		<div class="wcmp_headding1">
			...
			<button class="wcmp_ass_btn edit_shop_settings"><?php _e( 'Edit', $WCMp->text_domain );?></button>
			<div class="clear"></div>
		</div>
    	...
    	<div class="wcmp_form1">
				...
				<span style="display:block;" class="txt"><?php $dc_vendors_permalinks_array = get_option('dc_vendors_permalinks'); 
